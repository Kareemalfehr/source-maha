...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("•𝙈𝙊𝙃𝘼𝙈𝙀𝘿 𝙀𝙇𝙅𝙊𝙆𝙀𝙍", url=f"https://t.me/Elj_oker"),
                      InlineKeyboardButton("• قـنـأة ألـسـوُرس", url=f"https://t.me/CH_G6"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("💭 قـنـاة الـسـورس", url=f"https://t.me/CH_G6")
                        ],
                        [
